...
abstract class MongoCasbahSalatJsonRepository[A](_mongoCasbahRepository :MongoCasbahRepository) extends MongoCasbahSalatRepository[A](_mongoCasbahRepository) with CasbahPassthrough[A] {
